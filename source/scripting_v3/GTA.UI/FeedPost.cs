...
namespace GTA
{
    ...
    ///
    /// GTA.FeedPost is kept for backward compatibility but replaced with GTA.UI.FeedPost for compatibility with SHVDN 3.7.0 nightly v114+.
    /// </remarks>
    [Obsolete("GTA.FeedPost is obsolete. Use GTA.UI.FeedPost instead."), EditorBrowsable(EditorBrowsableState.Never)]
...
// Was forced to do this abomination to keep both backward and forward compatibility, since SHVDN broke the API.
namespace GTA.UI
{
    /// <summary>
    /// Represents a feed post (for the gameStream).
