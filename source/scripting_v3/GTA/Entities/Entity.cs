    ...
    public abstract class Entity : PoolObject, ISpatial
    {
        ...
        public bool KeepsDamageFlagsOnCleanupMissionState
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.v1_0_463_1 ? 400 : 396; // TODO: Find this offset dynamically
        ...
        public RelationshipGroup SpecificRelGroupForInflictorChecks
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.v1_0_463_1 ? 404 : 400; // TODO: Find this offset dynamically
